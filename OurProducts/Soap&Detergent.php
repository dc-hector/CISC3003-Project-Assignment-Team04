 	...
 	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="Soap&Detergent.php" style="text-decoration: none;color: balck;padding: 4px 12px;background-color: #4e8df5;border-radius: 12px;">Soap&Detergent</a></th>
    ...
    <div class="c-product-container">
        <div class="c-product-grid">
            ...
            $getposts = mysqli_query($con, 
                ...
                WHERE available >= 1 AND item = 'soap'
            ...
            ?>
                    <article class="c-product-card">
                        <a href="view_product.php?pid=<?= $id ?>">
                            <img src="../image/product/soap/<?= $picture ?>" 
            ...
            <?php 
                ...
                echo '<p class="c-empty-message">Currently no available soap.</p>';
            }
            ?>
        </div>
    </div>
