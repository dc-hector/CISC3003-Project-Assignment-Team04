	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="Hygene.php" style="text-decoration: none;color: balck;padding: 4px 12px;background-color: #4e8df5;border-radius: 12px;">Hygiene</a></th>
			</tr>
		</table>
	</div>
    <div class="c-product-container">
        <div class="c-product-grid">
            ...
            $getposts = mysqli_query($con, 
                ...
                WHERE available >= 1 AND item = 'hygiene'
            ...
            ?>
                    <article class="c-product-card">
                        <a href="view_product.php?pid=<?= $id ?>">
                            <img src="../image/product/hygiene/<?= $picture ?>" 
            ...
            <?php 
                ...
                echo '<p class="c-empty-message">Currently no available hygiene.</p>';
            }
            ?>
        </div>
    </div>
