 	...
 	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="Snacks.php" style="text-decoration: none;color: black;padding: 4px 12px;background-color: #4e8df5;border-radius: 12px;">Snacks</a></th>
   ...
   <div class="c-product-container">
        <div class="c-product-grid">
            ...
            $getposts = mysqli_query($con, 
                ...
                WHERE available >= 1 AND item = 'snack'
            ...
            ?>
                    <article class="c-product-card">
                        <a href="view_product.php?pid=<?= $id ?>">
                            <img src="../image/product/snack/<?= $picture ?>" 
            ...
            <?php 
                ...
                echo '<p class="c-empty-message">Currently no available snacks.</p>';
            }
            ?>
        </div>
    </div>
