	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="Drinks.php" style="text-decoration: none;color: black;padding: 4px 12px;background-color: #4e8df5;border-radius: 12px;">Drinks</a></th>
    ...
    <div class="c-product-container">
        <div class="c-product-grid">
            ...
            $getposts = mysqli_query($con, 
                ...
                WHERE available >= 1 AND item = 'drink'
            ...
            ?>
                    <article class="c-product-card">
                        <a href="view_product.php?pid=<?= $id ?>">
                            <img src="../image/product/drink/<?= $picture ?>" 
            ...
            <?php 
                ...
                echo '<p class="c-empty-message">Currently no available drinks.</p>';
            }
            ?>
        </div>
    </div>
