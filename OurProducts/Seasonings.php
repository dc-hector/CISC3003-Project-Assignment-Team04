...
<body>
 	...
 	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="Seasonings.php" style="text-decoration: none;color: #040403;padding: 4px 12px;background-color: #4e8df5 ;border-radius: 12px;">Seasonings</a></th>
    ...
    <div class="c-product-grid">
        ...
        $getposts = mysqli_query($con, 
            ...
            WHERE available >= 1 AND item = 'seasoning'
        ...
        ?>
                <article class="c-product-card">
                    <a href="view_product.php?pid=<?= $id ?>">
                        <img src="../image/product/seasoning/<?= $picture ?>" 
        ...
        <?php 
            ...
            echo '<p class="c-empty-message">Currently no available seasonings.</p>';
        }
        ?>
    </div>
